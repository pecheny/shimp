...
class InputSystemsContainer<TPos:IPos<TPos>> extends FSM<InputSystemsContainerStates, InputSystemsContainer<TPos>> implements SwitchableInputTarget<TPos> implements SwitchableInputTargets<TPos>  {
